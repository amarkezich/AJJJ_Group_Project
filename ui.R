        ...
        sidebarLayout(
          ...
          mainPanel(
            ...
            h4("Our team has designed four analytical maps that show the change of birthrate overtime within the last five years from 2012 to 2016.
                ...
                statistics of birthrate by state per year, income versus birthrate analysis based on income per year for every state, 
                the changes of birth rate per year for every state, race populations on average over the last five years, and the education
                attainment per year for every state.This project was designed by a group of four innovative informatic students who are passionate 
                to make a difference in a world through data science. We believe that through this project on birthrates statistics and fields 
